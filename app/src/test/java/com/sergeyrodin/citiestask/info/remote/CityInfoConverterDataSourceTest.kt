...
class CityInfoConverterDataSourceTest{
    ...
    fun featureCityItems_nameEquals() = runBlockingTest{
        ...
        val item3 = GeonamesItem("City", "Country", "city")
    ...
    fun noFeatureCity_cityNameFirst_nameEquals() = runBlockingTest{
        val item1 = GeonamesItem("Item1City", "Country1")
        val item2 = GeonamesItem("Item2City", "Country1")
        val item3 = GeonamesItem("CityItem", "Country1")
        val item4 = GeonamesItem("Items3City", "Country1")
        dataSource.addGeoNames(item1, item2, item3, item4)
